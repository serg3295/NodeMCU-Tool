...
const _logger = require('logging-facility').getLogger('serial');
...
function connect(devicename, baudrate, delimiterSequence = [10, 13]) {
...
module.exports = {
    ...
    isConnected: _serialport.isConnected,
};
